<nav class="bg-gray-800">
    ...
    <div class="flex h-16 items-center justify-between">
      ...
      <div class="hidden md:block">
        <div class="ml-4 flex items-center md:ml-6">
          ...
          <!-- Profile dropdown (only when logged in). Otherwise show Register link -->
          <?php if($_SESSION['user'] ?? false): ?>
            <div class="flex items-center">
          ...
          <?php else: ?>
            <a href="<?= '/register' ?>" class="<?php if($_SERVER['REQUEST_URI'] === '/about'){echo'bg-gray-900';} ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Register</a>
            <a href="<?= '/login' ?>" class="<?php if($_SERVER['REQUEST_URI'] === '/about'){echo'bg-gray-900';} ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Log In</a>
          <?php endif; ?>
        </div>
      </div>
  ...
  <el-disclosure id="mobile-menu" hidden class="block md:hidden">
    <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
      <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-white/5 hover:text-white" -->
      <a href="/" aria-current="page" class="block rounded-md <?php if($_SERVER['REQUEST_URI'] === '/'){echo'bg-gray-900';} ?> px-3 py-2 text-base font-medium text-white"><H2>Home</H2></a>
      <a href="/contact" class="block rounded-md <?php if($_SERVER['REQUEST_URI'] === '/contact'){echo'bg-gray-900';} ?> px-3 py-2 text-base font-medium text-gray-300 hover:bg-white/5 hover:text-white">Contact</a>
      <a href="/about" class="block rounded-md <?php if($_SERVER['REQUEST_URI'] === '/about'){echo'bg-gray-900';} ?> px-3 py-2 text-base font-medium text-gray-300 hover:bg-white/5 hover:text-white">About</a>
